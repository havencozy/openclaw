...
export function createSessionsSpawnTool(
  ...
  return {
    ...
    name: "sessions_spawn",
    description:
      'Spawn an isolated session (runtime="subagent" or runtime="acp"). mode="run" is one-shot and mode="session" is persistent. When thread=true and supported by the channel, the session is thread-bound. Subagents inherit the parent workspace directory automatically.',
